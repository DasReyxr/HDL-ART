...
CA2         U00 (.In(B),.Out(Out_CA2),.Enable(CA2));
Bit_Wise    U111 (.A(A),.B(Out_CA2),.Cin(Cin),.G(G_signal),.P(P_signal),.Cin_O(Carry2HC));
...
XOR U0  (.C(Enable),.P(In[0]),.S(xout[0]));
XOR U1  (.C(Enable),.P(In[1]),.S(xout[1]));
XOR U2  (.C(Enable),.P(In[2]),.S(xout[2]));
XOR U3  (.C(Enable),.P(In[3]),.S(xout[3]));
XOR U4  (.C(Enable),.P(In[4]),.S(xout[4]));
XOR U5  (.C(Enable),.P(In[5]),.S(xout[5]));
XOR U6  (.C(Enable),.P(In[6]),.S(xout[6]));
XOR U7  (.C(Enable),.P(In[7]),.S(xout[7]));
XOR U8  (.C(Enable),.P(In[8]),.S(xout[8]));
XOR U9  (.C(Enable),.P(In[9]),.S(xout[9]));
XOR U10 (.C(Enable),.P(In[10]),.S(xout[10]));
XOR U11 (.C(Enable),.P(In[11]),.S(xout[11]));
XOR U12 (.C(Enable),.P(In[12]),.S(xout[12]));
XOR U13 (.C(Enable),.P(In[13]),.S(xout[13]));
XOR U14 (.C(Enable),.P(In[14]),.S(xout[14]));
XOR U15 (.C(Enable),.P(In[15]),.S(xout[15]));

HA U17 (.A(xout[0]) ,.B(Enable) ,.G(S0) ,.P(Out[0]));
HA U18 (.A(xout[1]) ,.B(S0) ,.G(S1) ,.P(Out[1]));
HA U19 (.A(xout[2]) ,.B(S1) ,.G(S2) ,.P(Out[2]));
HA U20 (.A(xout[3]) ,.B(S2) ,.G(S3) ,.P(Out[3]));
HA U21 (.A(xout[4]) ,.B(S3) ,.G(S4) ,.P(Out[4]));
HA U22 (.A(xout[5]) ,.B(S4) ,.G(S5) ,.P(Out[5]));
HA U23 (.A(xout[6]) ,.B(S5) ,.G(S6) ,.P(Out[6]));
HA U24 (.A(xout[7]) ,.B(S6) ,.G(S7) ,.P(Out[7]));
HA U25 (.A(xout[8]) ,.B(S7) ,.G(S8) ,.P(Out[8]));
HA U26 (.A(xout[9]) ,.B(S8) ,.G(S9) ,.P(Out[9]));
HA U27 (.A(xout[10]) ,.B(S9) ,.G(S10) ,.P(Out[10]));
HA U28 (.A(xout[11]) ,.B(S10) ,.G(S11) ,.P(Out[11]));
HA U29 (.A(xout[12]) ,.B(S11) ,.G(S12) ,.P(Out[12]));
HA U30 (.A(xout[13]) ,.B(S12) ,.G(S13) ,.P(Out[13]));
HA U31 (.A(xout[14]) ,.B(S13) ,.G(S14) ,.P(Out[14]));
HA U32 (.A(xout[15]) ,.B(S14) ,.G() ,.P(Out[15]));
endmodule
