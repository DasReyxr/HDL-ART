...
--  mant_sum_abs <= unsigned(-mant_sum_signed) when mant1_shifted >= mant2_shifted else unsigned(mant_sum_signed);
    ...
    shift_count <=
        0  when mant_sum_signed(23) = '1' else
        1  when mant_sum_signed(22) = '1' else
        2  when mant_sum_signed(21) = '1' else
        3  when mant_sum_signed(20) = '1' else
        4  when mant_sum_signed(19) = '1' else
        5  when mant_sum_signed(18) = '1' else
        6  when mant_sum_signed(17) = '1' else
        7  when mant_sum_signed(16) = '1' else
        8  when mant_sum_signed(15) = '1' else
        9  when mant_sum_signed(14) = '1' else
        10 when mant_sum_signed(13) = '1' else
        11 when mant_sum_signed(12) = '1' else
        12 when mant_sum_signed(11) = '1' else
        13 when mant_sum_signed(10) = '1' else
        14 when mant_sum_signed(9) = '1' else
        15 when mant_sum_signed(8)  = '1' else
        16 when mant_sum_signed(7)  = '1' else
        17 when mant_sum_signed(6)  = '1' else
        18 when mant_sum_signed(5)  = '1' else
        19 when mant_sum_signed(4)  = '1' else
        20 when mant_sum_signed(3)  = '1' else
        21 when mant_sum_signed(2)  = '1' else
        22 when mant_sum_signed(1)  = '1' else
        23 when mant_sum_signed(0)  = '1' else
        24;
